...
# 设置循环次数
LOOP_COUNT=10  # 将5替换为你需要的循环次数

# 需要修改的路径
CNF_DIR="../2021cnf"
OUTPUT_DIR="..//modify1-cadical-rel-2.0.0"
CADICAL_PATH="..//modify1-cadical-rel-2.0.0/build/cadical"
...
process_file() {
    ...
    # 提取process-time所在行
    grep "total process time since initialization" "$output_file" >> "$temp_file"
