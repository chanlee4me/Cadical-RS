...
struct Internal {
  ...
  //
  /*--------------added by cl---------------*/
  int &hitFreq (int lit) { return htab[vidx (lit)]; }
  /*-------------------end------------------*/
  ...
  void bump_variable_score (int lit, int glue = 0);
  ...
  void bump_variable (int lit, int glue = 0);
  void bump_variables (int glue = 0);
